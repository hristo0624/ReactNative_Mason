...
const commonConfig = merge([
  {
    ...
    resolve: {
      ...
      alias: {
        ...
        'workordersrc': path.resolve(projectPath, 'workordersrc'),
...
const productionConfig = merge([
  ...
  parts.loadSVG(),
  {
    ...
    output: {
      ...
      path: path.resolve(projectPath, 'workorderDist'),
      publicPath: '/',
...
const developmentConfig = merge([
  ...
  parts.devServer({
    ...
    contentBase: path.resolve(projectPath, 'workorderDist')
  }),
  parts.loadImages({
    options: {
      limit: 1024,
