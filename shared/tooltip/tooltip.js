...
} from 'shared/tooltip/geom';
import styles from 'shared/tooltip/styles';
...
export default class Tooltip extends React.Component {
  ...
  getArrowDynamicStyle = () => {
    ...
    console.log("tooltipOrigin=", tooltipOrigin)
  ...
  render() {
    ...
    const { backgroundColor, children, content, isVisible, onClose, customStyle } = this.props;

    const contentStyle = [styles.content, customStyle.contentBackground];
    ...
    return (
      <View>
        ...
        <Modal transparent visible={isVisible && !waitingForInteractions} >
            ...
            >
              ...
              />
              <Animated.View
                style={[styles.tooltip, tooltipPlacementStyles]}
              >
