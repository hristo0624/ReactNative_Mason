...
const commonConfig = merge([
  {
    ...
    resolve: {
      ...
      alias: {
        ...
        'proposalsrc': path.resolve(projectPath, 'proposalsrc'),
...
const productionConfig = merge([
  ...
  parts.loadSVG(),
  {
    ...
    output: {
      ...
      path: path.resolve(projectPath, 'proposalDist'),
      publicPath: '/',
...
const developmentConfig = merge([
  ...
  parts.devServer({
    ...
    contentBase: path.resolve(projectPath, 'proposalDist')
  }),
  parts.loadImages({
    options: {
      limit: 1024,
